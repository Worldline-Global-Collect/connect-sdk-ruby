...
CommunicatorConfiguration ||= Worldline::Connect::SDK::CommunicatorConfiguration
...
describe 'CommunicatorConfiguration' do
  ...
  it 'can be constructed without a proxy' do
    ...
    expect(communicator_config.api_endpoint).to eq('https://api.preprod.connect.worldline-solutions.com')
  ...
  it 'uses specific scheme to override default' do
    ...
    expect(communicator_config.api_endpoint).to eq('http://api.preprod.connect.worldline-solutions.com')
  end
  ...
  it 'uses specific port to override default' do
    ...
    expect(communicator_config.api_endpoint).to eq('https://api.preprod.connect.worldline-solutions.com:8080')
  end
  ...
  it 'uses specific scheme and port to override default' do
    ...
    expect(communicator_config.api_endpoint).to eq('http://api.preprod.connect.worldline-solutions.com:8080')
  end
  ...
  it 'stores shoppingCartExtension data' do
    yaml = '---
            ...
            connect.api.connectTimeout: 20
            connect.api.socketTimeout: 10
            connect.api.integrator: Worldline.Integrator
            connect.api.shoppingCartExtension.creator: Worldline.Creator
            connect.api.shoppingCartExtension.name: Worldline.ShoppingCarts
