...
describe 'V1HMACAuthenticator' do
  ...
  let(:authenticator) {Worldline::Connect::SDK::Authentication::V1HMACAuthenticator.new('apiKeyId', 'secretApiKey')}
  ...
  context 'create_authentication_signature' do
    ...
    it 'creates authentication signatures for more than one key' do
      authenticator = Worldline::Connect::SDK::Authentication::V1HMACAuthenticator.new('apiKeyId', '6Kj5HT0MQKC6D8eb7W3lTg71kVKVDSt1')
      data_to_sign = "GET\n"+
                     "\n"+
                     "Fri, 06 Jun 2014 13:39:43 GMT\n"+
                     "/v1/9991/tokens/123456789\n"
