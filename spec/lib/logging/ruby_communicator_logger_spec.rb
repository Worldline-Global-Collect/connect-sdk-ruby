...
RubyCommunicatorLogger = Worldline::Connect::SDK::Logging::RubyCommunicatorLogger
  ...
  context 'logging without error' do
    ...
    context "with level 'INFO'" do
      ...
      it 'should not throw an exception when logging unicode strings' do
        message =  Worldline::Connect::SDK::Logging::ResponseLogMessageBuilder.new("aaa", 2345, 45.32)
        body = "Schröder"
        content = "JSON"
