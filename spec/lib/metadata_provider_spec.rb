...
describe 'MetadataProvider' do
  ...
  MetadataProvider ||= Worldline::Connect::SDK::Communication::MetadataProvider
  RequestHeader ||= Worldline::Connect::SDK::Communication::RequestHeader

  it 'can give metadata_headers with a full shopping cart' do
    shopping_cart_extension = Worldline::Connect::SDK::Domain::ShoppingCartExtension.new('Worldline.creator', 'Extension', '1.0', 'ExtensionId')
    ...
    server_meta_info = Worldline::Connect::SDK::JSON::DefaultMarshaller.instance.unmarshal(server_meta_info_json, MetadataProvider::ServerMetaInfo)
  ...
  it 'can give metadata_headers with a full shopping cart without an extension id' do
    shopping_cart_extension = Worldline::Connect::SDK::Domain::ShoppingCartExtension.new('Worldline.creator', 'Extension', '1.0')
    metadata_provider = MetadataProvider.new('Worldline', shopping_cart_extension: shopping_cart_extension)
