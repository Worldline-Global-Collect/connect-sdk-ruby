...
describe 'Client' do
  ...
  Connection ||= Worldline::Connect::SDK::Communication::Connection
  PooledConnection ||= Worldline::Connect::SDK::Communication::PooledConnection
  ...
  it 'should return properly modified clients from *with_client_meta_info*' do
    ...
    client_meta_info = Worldline::Connect::SDK::JSON::DefaultMarshaller.instance.marshal({test: 'test'})
