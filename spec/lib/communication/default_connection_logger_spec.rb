...
module ValidationDict
  ...
  def createPayment_unicode_response(message)
    ...
    expect(message).to match(%r(Location="api\.preprod\.connect\.worldline-solutions\.com/v1/1234/payments/000000123410000595980000100001"))
    expect(message).to match(DATA_JSON_HEADER)
    # expect(message).to match(DUMMY_HEADER)
    expect(message).to match(DATEHEADER)
    expect(message).to match(DATA_JSON)
...
describe 'DefaultConnectionLogging' do
  ...
  it 'should be able to log a simple request' do
    ...
    stub_request(:get, 'https://api.preprod.connect.worldline-solutions.com/v1/1234/services/testconnection')
  ...
  it 'can log a GET request with parameters' do
    ...
    stub_request(:get, 'https://api.preprod.connect.worldline-solutions.com/v1/1234/services/convert/amount?source=EUR&target=USD&amount=1000')
        .to_return(status: 200, body: response_body,
                   headers: base_headers.merge({'Content-Type' => 'application/json'}))

    query_params = Worldline::Connect::SDK::V1::Merchant::Services::ConvertAmountParams.new
  ...
  it 'can log DELETE requests' do
    stub_request(:delete, 'https://api.preprod.connect.worldline-solutions.com/v1/1234/tokens/5678')
  ...
  it 'can log POST responses' do
    ...
    stub_request(:post, 'https://api.preprod.connect.worldline-solutions.com/v1/1234/payments')
        .to_return(status: 201, body: response_body,
                   headers: base_headers.merge({'Content-Type' => 'application/json',
                                                'Location' => 'api.preprod.connect.worldline-solutions.com/v1/1234/payments/000000123410000595980000100001'}))
  ...
  it 'can log error responses' do
    ...
    CLIENT.enable_logging(logger)
    expect{CLIENT.v1.merchant('1234').payments.create(request)}.to raise_error(Worldline::Connect::SDK::V1::ValidationException)
  ...
  it 'logs rejected payments' do
    ...
    CLIENT.enable_logging(logger)
    expect{CLIENT.v1.merchant('1234').payments.create(request)}.to raise_error(Worldline::Connect::SDK::V1::DeclinedPaymentException)
  ...
  it 'logs general HTTP errors' do
    ...
    CLIENT.enable_logging(logger)
    expect{CLIENT.v1.merchant('1234').services.testconnection}.to raise_error(Worldline::Connect::SDK::V1::PlatformException)
  ...
  it 'logs non-json' do
    ...
    CLIENT.enable_logging(logger)
    expect{CLIENT.v1.merchant('1234').services.testconnection}.to raise_error(Worldline::Connect::SDK::Communication::NotFoundException)
  ...
  it 'logs timeouts' do
    ...
    CLIENT.enable_logging(logger)
    expect{CLIENT.v1.merchant('1234').services.testconnection}.to raise_error(Worldline::Connect::SDK::Communication::CommunicationException)
...
class TestLogger < Worldline::Connect::SDK::Logging::CommunicatorLogger
...
def create_payment_request
  ...
  card = Worldline::Connect::SDK::V1::Domain::Card.new
  card.cvv = '123'
  card.card_number = '4567350000427977'
  card.expiry_date = '1220'
  card_payment_method_specific_input = Worldline::Connect::SDK::V1::Domain::CardPaymentMethodSpecificInput.new
