...
DefaultConnection ||= Worldline::Connect::SDK::Communication::DefaultConnection
StdoutCommunicatorLogger ||= Worldline::Connect::SDK::Logging::StdoutCommunicatorLogger
...
describe DefaultConnection do
  ...
  context 'construction' do
    ...
    context 'with proxy' do
      ...
      context 'without authentication' do
        let(:proxy_configuration) { Worldline::Connect::SDK::ProxyConfiguration.new(address: uri) }
      ...
      context 'with authentication' do
        ...
        let(:proxy_configuration) do
          Worldline::Connect::SDK::ProxyConfiguration.new(address: uri,
                                                          username: username,
                                                          password: password)
        end
  ...
  context 'sending and receiving' do
    ...
    context 'without proxy' do
      ...
      let(:sdk_headers) { headers.map {|k, v| Worldline::Connect::SDK::Communication::ResponseHeader.new(k, v) } }
