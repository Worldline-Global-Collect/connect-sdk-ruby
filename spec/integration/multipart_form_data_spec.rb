...
describe 'multipart/form-data support' do
  ...
  it 'Can send a Multipart Form Data Object POST upload with a response' do
    ...
    multipart = Worldline::Connect::SDK::Communication::MultipartFormDataObject.new
    multipart.add_file 'file', Worldline::Connect::SDK::Domain::UploadableFile.new(
      'file.txt', 'file-content', 'text/plain'
    )

    multipart.add_value 'value', 'Hello World'

    communicator = Worldline::Connect::SDK::Factory.create_communicator_from_configuration configuration
...
class HttpBinResponse < Worldline::Connect::SDK::Domain::DataObject
  @form = nil
  @files = nil
...
class MultipartFormDataObjectWrapper < Worldline::Connect::SDK::Communication::MultipartFormDataRequest
  @multipart = nil
