...
require 'worldline/connect/sdk/communication/not_found_exception'
require 'worldline/connect/sdk/communication/pooled_connection'
require 'worldline/connect/sdk/communication/request_header'
require 'worldline/connect/sdk/communication/response_exception'
require 'worldline/connect/sdk/communication/response_header'
...
module Worldline
  module Connect
    module SDK
      # Class responsible for facilitating communication with the Worldline Global Collect platform.
      # It combines the following classes to provide communication functionality:
      #
      # api_endpoint::       the base URL to the Worldline Global Collect platform
      # connection::         {Worldline::Connect::SDK::Communication::Connection} used to communicate with the Worldline Global Collect platform
      # authenticator::      {Worldline::Connect::SDK::Authentication::Authenticator} used for authenticating messages sent
      # metadata_provider::  {Worldline::Connect::SDK::Communication::MetadataProvider} object containing information relevant for sending requests
      # marshaller::         {Worldline::Connect::SDK::JSON::Marshaller} that is used to marshal and unmarshal data to and from JSON format
      #
      # @attr_reader [Worldline::Connect::SDK::JSON::Marshaller] marshaller A Marshaller instance used by the communicator for serializing/deserializing to/from JSON
      #
      class Communicator
        ...
        #
        # @param api_endpoint      [String] the base URL to the Worldline Global Collect platform
        # @param connection        [Worldline::Connect::SDK::Communication::Connection] used to communicate with the Worldline Global Collect platform
        # @param authenticator     [Worldline::Connect::SDK::Authentication::Authenticator] used for authenticating messages sent
        # @param metadata_provider [Worldline::Connect::SDK::Communication::MetadataProvider] object containing information relevant for sending requests
        # @param marshaller        [Worldline::Connect::SDK::JSON::Marshaller] used to marshal and unmarshal data to and from JSON format
        #
        ...
        # @param request_headers    [Array<Worldline::Connect::SDK::Communication::RequestHeader>, nil] optional array of request headers
        # @param request_parameters [Worldline::Connect::SDK::Communication::ParamRequest, nil] optional request parameters
        # @param response_type      [Type] the response type.
        # @param context            [Worldline::Connect::SDK::CallContext, nil] optional call context.
        # @return the response of the GET request as the given response type
        # @raise [Worldline::Connect::SDK::Communication::ResponseException] if the request could not be fulfilled successfully.
        #        This occurs for example if the request is not authenticated correctly
        # @raise [Worldline::Connect::SDK::Communication::NotFoundException] if the requested resource is not found
        # @raise [Worldline::Connect::SDK::Communication::CommunicationException] if there is an error in communicating with the Worldline Global Collect platform.
        ...
        # @param request_headers    [Array<Worldline::Connect::SDK::Communication::RequestHeader>, nil] Optional array of request headers
        # @param request_parameters [Worldline::Connect::SDK::Communication::ParamRequest, nil] Optional request parameters
        # @param request_body       [Worldline::Connect::SDK::Domain::DataObject, Worldline::Connect::SDK::Communication::MultipartFormDataObject, Worldline::Connect::SDK::Communication::MultipartFormDataRequest, nil]
        ...
        # Will not have any effect if the connection is not a pooled connection (an instance of {Worldline::Connect::SDK::Communication::PooledConnection}).
        ...
        #
        # @param communicator_logger [Worldline::Connect::SDK::Logging::CommunicatorLogger] The communicator logger the requests and responses are logged to
        ...
        # @param request_parameters [Array<Worldline::Connect::SDK::Communication::RequestParam>] A list of request parameters that each have #name and #value
        ...
        # @param uri             [URI::HTTP] The full URI to the Worldline Global Collect platform,
        #                        including the relative path and request parameters.
        # @param request_headers [Array<Worldline::Connect::SDK::Communication::RequestHeader>] List of request headers in which which new headers will be added
        # @param context         [Worldline::Connect::SDK::CallContext, nil] object that will be used to produce
