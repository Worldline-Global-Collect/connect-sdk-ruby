...
require 'worldline/connect/sdk/v1/domain/payment_product_filters_hosted_checkout'
require 'worldline/connect/sdk/v1/domain/recurring_payments_data'
    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::RecurringPaymentsData] recurring_payments_data
          ...
          class HostedCheckoutSpecificInput < Worldline::Connect::SDK::Domain::DataObject
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'paymentProductFilters'
                ...
                @payment_product_filters = Worldline::Connect::SDK::V1::Domain::PaymentProductFiltersHostedCheckout.new_from_hash(hash['paymentProductFilters'])
              end
              if hash.has_key? 'recurringPaymentsData'
                ...
                @recurring_payments_data = Worldline::Connect::SDK::V1::Domain::RecurringPaymentsData.new_from_hash(hash['recurringPaymentsData'])
              end
