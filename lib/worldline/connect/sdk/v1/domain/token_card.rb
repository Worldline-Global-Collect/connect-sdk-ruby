    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::TokenCardData] data
          class TokenCard < Worldline::Connect::SDK::V1::Domain::AbstractToken
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'data'
                ...
                @data = Worldline::Connect::SDK::V1::Domain::TokenCardData.new_from_hash(hash['data'])
              end
            end
          end
        end
