...
require 'worldline/connect/sdk/v1/domain/mandate_sepa_direct_debit'
    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::MandateSepaDirectDebit] mandate
          class TokenSepaDirectDebit < Worldline::Connect::SDK::V1::Domain::AbstractToken
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'mandate'
                ...
                @mandate = Worldline::Connect::SDK::V1::Domain::MandateSepaDirectDebit.new_from_hash(hash['mandate'])
              end
            end
          end
        end
