...
require 'worldline/connect/sdk/v1/domain/airline_passenger'
    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Array<Worldline::Connect::SDK::V1::Domain::AirlineFlightLeg>] flight_legs
          ...
          # @attr [Array<Worldline::Connect::SDK::V1::Domain::AirlinePassenger>] passengers
          ...
          class AirlineData < Worldline::Connect::SDK::Domain::DataObject
