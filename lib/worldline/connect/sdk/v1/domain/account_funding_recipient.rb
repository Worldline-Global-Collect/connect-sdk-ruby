...
require 'worldline/connect/sdk/v1/domain/afr_name'
    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::AfrName] name
          # @attr [String] partial_pan
          class AccountFundingRecipient < Worldline::Connect::SDK::Domain::DataObject
