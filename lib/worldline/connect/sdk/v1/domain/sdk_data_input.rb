...
require 'worldline/connect/sdk/v1/domain/device_render_options'
...
module Worldline
  module Connect
    module SDK
      module V1
        module Domain
          # @attr [Worldline::Connect::SDK::V1::Domain::DeviceRenderOptions] device_render_options
          ...
          class SdkDataInput < Worldline::Connect::SDK::Domain::DataObject
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'deviceRenderOptions'
                ...
                @device_render_options = Worldline::Connect::SDK::V1::Domain::DeviceRenderOptions.new_from_hash(hash['deviceRenderOptions'])
              end
