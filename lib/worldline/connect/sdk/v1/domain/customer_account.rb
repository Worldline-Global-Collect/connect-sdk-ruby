...
require 'worldline/connect/sdk/v1/domain/customer_account_authentication'
require 'worldline/connect/sdk/v1/domain/customer_payment_activity'
require 'worldline/connect/sdk/v1/domain/payment_account_on_file'
...
module Worldline
  module Connect
    module SDK
      module V1
        module Domain
          # @attr [Worldline::Connect::SDK::V1::Domain::CustomerAccountAuthentication] authentication
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::PaymentAccountOnFile] payment_account_on_file
          # @attr [String] payment_account_on_file_type
          # @attr [Worldline::Connect::SDK::V1::Domain::CustomerPaymentActivity] payment_activity
          class CustomerAccount < Worldline::Connect::SDK::Domain::DataObject
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'authentication'
                ...
                @authentication = Worldline::Connect::SDK::V1::Domain::CustomerAccountAuthentication.new_from_hash(hash['authentication'])
              end
              ...
              if hash.has_key? 'paymentAccountOnFile'
                ...
                @payment_account_on_file = Worldline::Connect::SDK::V1::Domain::PaymentAccountOnFile.new_from_hash(hash['paymentAccountOnFile'])
              end
              ...
              if hash.has_key? 'paymentActivity'
                ...
                @payment_activity = Worldline::Connect::SDK::V1::Domain::CustomerPaymentActivity.new_from_hash(hash['paymentActivity'])
              end
            end
          end
        end
