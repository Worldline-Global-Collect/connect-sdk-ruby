    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::CreateMandateBase] mandate
          class SepaDirectDebitPaymentProduct771SpecificInputBase < Worldline::Connect::SDK::V1::Domain::AbstractSepaDirectDebitPaymentProduct771SpecificInput
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'mandate'
                ...
                @mandate = Worldline::Connect::SDK::V1::Domain::CreateMandateBase.new_from_hash(hash['mandate'])
              end
            end
          end
        end
