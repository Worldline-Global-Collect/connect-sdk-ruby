...
require 'worldline/connect/sdk/v1/domain/lodging_charge'
require 'worldline/connect/sdk/v1/domain/lodging_room'
...
module Worldline
  module Connect
    module SDK
      module V1
        module Domain
          # @attr [Array<Worldline::Connect::SDK::V1::Domain::LodgingCharge>] charges
          ...
          # @attr [Array<Worldline::Connect::SDK::V1::Domain::LodgingRoom>] rooms
          class LodgingData < Worldline::Connect::SDK::Domain::DataObject
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'charges'
                ...
                hash['charges'].each do |e|
                  @charges << Worldline::Connect::SDK::V1::Domain::LodgingCharge.new_from_hash(e)
                end
              end
              ...
              if hash.has_key? 'rooms'
                ...
                hash['rooms'].each do |e|
                  @rooms << Worldline::Connect::SDK::V1::Domain::LodgingRoom.new_from_hash(e)
                end
              end
            end
          end
