    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::PaymentProduct302SpecificData] payment_product302_specific_data
          # @attr [Worldline::Connect::SDK::V1::Domain::PaymentProduct320SpecificData] payment_product320_specific_data
          # @attr [Worldline::Connect::SDK::V1::Domain::PaymentProduct863SpecificData] payment_product863_specific_data
          # @attr [String] payment_product_group
          # @attr [true/false] supports_mandates
          # @attr [true/false] uses_redirection_to3rd_party
          class PaymentProduct < Worldline::Connect::SDK::Domain::DataObject
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'authenticationIndicator'
                ...
                @authentication_indicator = Worldline::Connect::SDK::V1::Domain::AuthenticationIndicator.new_from_hash(hash['authenticationIndicator'])
              end
              ...
              if hash.has_key? 'paymentProduct302SpecificData'
                ...
                @payment_product302_specific_data = Worldline::Connect::SDK::V1::Domain::PaymentProduct302SpecificData.new_from_hash(hash['paymentProduct302SpecificData'])
              end
              if hash.has_key? 'paymentProduct320SpecificData'
                ...
                @payment_product320_specific_data = Worldline::Connect::SDK::V1::Domain::PaymentProduct320SpecificData.new_from_hash(hash['paymentProduct320SpecificData'])
              end
              if hash.has_key? 'paymentProduct863SpecificData'
                ...
                @payment_product863_specific_data = Worldline::Connect::SDK::V1::Domain::PaymentProduct863SpecificData.new_from_hash(hash['paymentProduct863SpecificData'])
              end
