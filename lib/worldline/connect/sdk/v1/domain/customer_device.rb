    ...
    module SDK
      module V1
        module Domain
          ...
          # @attr [Worldline::Connect::SDK::V1::Domain::BrowserData] browser_data
          ...
          class CustomerDevice < Worldline::Connect::SDK::Domain::DataObject
            ...
            def from_hash(hash)
              ...
              if hash.has_key? 'browserData'
                ...
                @browser_data = Worldline::Connect::SDK::V1::Domain::BrowserData.new_from_hash(hash['browserData'])
              end
