...
require 'worldline/connect/sdk/v1/domain/bank_transfer_payment_method_specific_input_base'
require 'worldline/connect/sdk/v1/domain/card_payment_method_specific_input_base'
require 'worldline/connect/sdk/v1/domain/cash_payment_method_specific_input_base'
require 'worldline/connect/sdk/v1/domain/e_invoice_payment_method_specific_input_base'
...
require 'worldline/connect/sdk/v1/domain/mobile_payment_method_specific_input_hosted_checkout'
require 'worldline/connect/sdk/v1/domain/order'
require 'worldline/connect/sdk/v1/domain/redirect_payment_method_specific_input_base'
require 'worldline/connect/sdk/v1/domain/sepa_direct_debit_payment_method_specific_input_base'
...
module Worldline
  module Connect
    module SDK
      module V1
        module Domain
          # @attr [Worldline::Connect::SDK::V1::Domain::BankTransferPaymentMethodSpecificInputBase] bank_transfer_payment_method_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::CardPaymentMethodSpecificInputBase] card_payment_method_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::CashPaymentMethodSpecificInputBase] cash_payment_method_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::EInvoicePaymentMethodSpecificInputBase] e_invoice_payment_method_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::FraudFields] fraud_fields
          # @attr [Worldline::Connect::SDK::V1::Domain::HostedCheckoutSpecificInput] hosted_checkout_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::Merchant] merchant
          # @attr [Worldline::Connect::SDK::V1::Domain::MobilePaymentMethodSpecificInputHostedCheckout] mobile_payment_method_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::Order] order
          # @attr [Worldline::Connect::SDK::V1::Domain::RedirectPaymentMethodSpecificInputBase] redirect_payment_method_specific_input
          # @attr [Worldline::Connect::SDK::V1::Domain::SepaDirectDebitPaymentMethodSpecificInputBase] sepa_direct_debit_payment_method_specific_input
          class CreateHostedCheckoutRequest < Worldline::Connect::SDK::Domain::DataObject
