...
require 'worldline/connect/sdk/v1/domain/risk_assessment_response'
      ...
      module V1
        module Merchant
          module Riskassessments
            ...
            class RiskassessmentsClient < Worldline::Connect::SDK::ApiResource
              ...
              def bankaccounts(body, context = nil)
                ...
                @communicator.post(
                  ...
                  nil,
                  body,
                  Worldline::Connect::SDK::V1::Domain::RiskAssessmentResponse,
                  context)
