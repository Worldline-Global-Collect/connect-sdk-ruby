...
module Worldline
  module Connect
    module SDK
      ...
      # Provides shared functionality to facilitate communication with the Worldline Global Collect platform.
      #
      # @attr_reader [Worldline::Connect::SDK::Communicator] communicator Communicator instance that provides communication with the Worldline Global Collect platform.
      ...
      class ApiResource
        ...
        #
        # @param parent           [Worldline::Connect::SDK::ApiResource] parent resource instance.
        # @param communicator     [Worldline::Connect::SDK::Communicator] Communicator instance.
        ...
        # @return [Array<Worldline::Connect::SDK::Communication::RequestHeader>, nil] the client headers,
