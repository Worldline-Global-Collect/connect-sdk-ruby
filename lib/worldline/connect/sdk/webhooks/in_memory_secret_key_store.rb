require 'concurrent'
require 'singleton'
require 'worldline/connect/sdk/webhooks/secret_key_not_available_exception'
require 'worldline/connect/sdk/webhooks/secret_key_store'
    ...
    module SDK
      module Webhooks
        ...
        class InMemorySecretKeyStore
          ...
          # @raise [Worldline::Connect::SDK::Webhooks::SecretKeyNotAvailableException] if the secret key for the given key id is not available.
