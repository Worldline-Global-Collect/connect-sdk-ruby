...
require 'worldline/connect/sdk/authentication/authenticator'
    ...
    module SDK
      module Authentication
        ...
        class V1HMACAuthenticator < Authenticator
          ...
          # Construct a new V1HMACAuthenticator instance that can sign requests
          ...
          # @param http_headers [Array<Worldline::Connect::SDK::Communicator::RequestHeader>] list that contains all headers used by the request
          ...
          def to_data_to_sign(http_method, resource_uri, http_headers)
            ...
            http_headers.each do |header|
              ...
              case
              when name.casecmp('Content-Type') == 0
                content_type = value
