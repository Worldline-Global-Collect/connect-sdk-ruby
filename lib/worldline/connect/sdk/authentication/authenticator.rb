  ...
  module Connect
    module SDK
      module Authentication
        # Abstract class that is responsible for authenticating requests sent to the Worldline Global Collect platform.
        class Authenticator
          ...
          # @param request_headers [Array<Worldline::Connect::SDK::Communication::RequestHeader>] all headers used by the request
