require 'worldline/connect/sdk/communication/connection'

module Worldline
  module Connect
    module SDK
      module Communication
        # {Worldline::Connect::SDK::Communication::Connection} that supports connection pooling. This is used to more efficiently communicate using HTTP.
