...
require 'worldline/connect/sdk/logging/obfuscation/body_obfuscator'
require 'worldline/connect/sdk/logging/obfuscation/header_obfuscator'
require 'worldline/connect/sdk/logging/request_log_message_builder'
require 'worldline/connect/sdk/logging/response_log_message_builder'
    ...
    module SDK
      module Communication
        class DefaultConnection < PooledConnection
          ...
          #              Uses {Worldline::Connect::SDK::CommunicatorConfiguration.default_max_connections} if not given.
          # @option args [Worldline::Connect::SDK::ProxyConfiguration] :proxy_configuration object that stores the proxy to use.
          ...
          def initialize(args)
            ...
            @body_obfuscator = Worldline::Connect::SDK::Logging::Obfuscation::BodyObfuscator.default_obfuscator
            @header_obfuscator = Worldline::Connect::SDK::Logging::Obfuscation::HeaderObfuscator.default_obfuscator
          end
          ...
          # Performs a GET request to the Worldline Global Collect platform
          # @see request
          ...
          # Performs a DELETE request to the Worldline Global Collect platform
          # @see request
          ...
          # Performs a POST request to the Worldline Global Collect platform
          # @see request
          ...
          # Performs a PUT request to the Worldline Global Collect platform
          # @see request
          ...
          # @param request_headers [Array<Worldline::Connect::SDK::Communication::RequestHeader>] list of headers that should be used as HTTP headers in the request.
          # @param body            [String, Worldline::Connect::SDK::Communication::MultipartFormDataObject] request body.
          ...
          # @raise [Worldline::Connect::SDK::Communication::CommunicationException] when communication with the Worldline Global Collect platform was not successful.
          ...
          # Converts a {Worldline::Connect::SDK::Communication::RequestHeader} list headers to a hash
          def convert_from_sdk_headers(headers)
            headers.each_with_object({}) { |h, hash| hash[h.name] = h.value }
          end

          # Converts a hash to a {Worldline::Connect::SDK::Communication::ResponseHeader} list
          ...
          def log_request(request_id, method, uri, args = {})
            ...
            log_msg_builder = Worldline::Connect::SDK::Logging::RequestLogMessageBuilder.new(request_id, method, uri,
                                                                                             @body_obfuscator,
                                                                                             @header_obfuscator)
          ...
          def log_response(request_id, status_code, start_time, args = {})
            ...
            log_msg_builder = Worldline::Connect::SDK::Logging::ResponseLogMessageBuilder.new(request_id, status_code, duration,
                                                                                              @body_obfuscator,
                                                                                              @header_obfuscator)
            unless headers.nil?
          ...
          #
          # Yields a status code, an array of {Worldline::Connect::SDK::Communication::ResponseHeader},
